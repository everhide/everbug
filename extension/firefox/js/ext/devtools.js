var hwd = null;
var port = null;
var tab = browser.devtools.inspectedWindow.tabId;

browser.devtools.panels.create("Everbug", "../img/icons/icon_32.png", "../html/panel.html", function(plugin){
    plugin.onShown.addListener(function captureHandle(handleWindow){
        hwd = handleWindow;
        port = browser.runtime.connect({name: 'everbug-devtool'});
